...
/* Obtain cyHost and cyPort for the first and create the client socket from it.
   Note: This might be changed in the connect button method at the bottom of the file!
 */
cyHost = document.getElementById('cyHost').value || '127.0.0.1';
cyPort = document.getElementById('cyPort').value || '15525';
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  client.onCommand = function (text) {
    ...
    if (newCmd[2] == "KeyModel") {
      ...
      if (selected_model == parseInt(newCmd[3])) {
        return;
      }
